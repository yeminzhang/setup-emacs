...
(:id "cu" :type "other" :root-dir "~/bsp/capturing-unit/" :grep-root "~/bsp/capturing-unit/src/ ~/bsp/capturing-unit/root/" :tag-command "etags src/*" :compile-command "../make-cu-remote")
))
