...
(package-initialize)
(dolist (pkg '(smex company dired+ helm helm-gtags magit undo-tree zenburn-theme volatile-highlights function-args projectile helm-projectile company-c-headers yasnippet helm-c-yasnippet))
